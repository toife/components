...
const _wellKnownSymbolNameRegExp = /^__@(\w+)$/;
...
const _uniqueSymbolNameRegExp = /^__@.*@\d+$/;
export class TypeScriptHelpers {
    ...
    static tryDecodeWellKnownSymbolName(name) {
        const match = _wellKnownSymbolNameRegExp.exec(name);
        if (match) {
    ...
    static isUniqueSymbolName(name) {
        return _uniqueSymbolNameRegExp.test(name);
    }
    /**
