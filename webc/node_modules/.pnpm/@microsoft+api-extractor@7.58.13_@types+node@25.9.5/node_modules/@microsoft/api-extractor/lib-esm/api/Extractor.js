...
export class Extractor {
    ...
    static invoke(extractorConfig, options) {
        ...
        const { localBuild = false, compilerState = CompilerState.create(extractorConfig, options), messageCallback, showVerboseMessages = false, showDiagnostics = false, printApiReportDiff = false } = options ?? {};
