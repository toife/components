...
function _generateTypingsFileContent(collector, writer, dtsKind) {
 ...
 */
function _modifySpan(collector, span, entity, astDeclaration, dtsKind) {
...
function _shouldIncludeReleaseTag(releaseTag, dtsKind) {
    switch (dtsKind) {
