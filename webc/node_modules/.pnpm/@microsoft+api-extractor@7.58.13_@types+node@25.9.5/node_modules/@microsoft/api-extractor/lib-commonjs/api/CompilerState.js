...
class CompilerState {
    ...
    static create(extractorConfig, options) {
        ...
        const compilerHost = _createCompilerHost(commandLine, options);
 ...
 */
function _generateFilePathsForAnalysis(inputFilePaths) {
...
function _createCompilerHost(commandLine, options) {
