...
class Collector {
    ...
    _astEntryPoint;
    _entities = [];
    _entitiesByAstEntity = new Map();
    _entitiesBySymbol = new Map();
    _starExportedExternalModulePaths = [];
    _dtsTypeReferenceDirectives = new Set();
    _dtsLibReferenceDirectives = new Set();
    // Used by getOverloadIndex()
    _cachedOverloadIndexesByDeclaration;
    constructor(options) {
