...
class MessageRouter {
    ...
    _workingPackageFolder;
    _messageCallback;
    // All messages
    _messages;
    // For each AstDeclaration, the messages associated with it.  This is used when addToApiReportFile=true
    _associatedMessagesForAstDeclaration;
    _sourceMapper;
    _tsdocConfiguration;
    // Normalized representation of the routing rules from api-extractor.json
    _reportingRuleByMessageId = new Map();
    _compilerDefaultRule = {
        logLevel: ExtractorLogLevel_1.ExtractorLogLevel.None,
        addToApiReportFile: false
    };
    _extractorDefaultRule = {
        logLevel: ExtractorLogLevel_1.ExtractorLogLevel.None,
        addToApiReportFile: false
    };
    _tsdocDefaultRule = { logLevel: ExtractorLogLevel_1.ExtractorLogLevel.None, addToApiReportFile: false };
    errorCount = 0;
    warningCount = 0;
    /**
