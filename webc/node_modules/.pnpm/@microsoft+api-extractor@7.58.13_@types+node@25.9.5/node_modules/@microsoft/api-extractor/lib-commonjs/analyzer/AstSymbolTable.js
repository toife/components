...
class AstSymbolTable {
    ...
    _typeChecker;
    _messageRouter;
    _globalVariableAnalyzer;
    _packageMetadataManager;
    _exportAnalyzer;
    _alreadyWarnedGlobalNames;
    /**
