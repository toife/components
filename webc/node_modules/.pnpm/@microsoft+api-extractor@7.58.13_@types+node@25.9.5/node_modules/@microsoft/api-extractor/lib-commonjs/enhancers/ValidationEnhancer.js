...
function _checkForInternalUnderscore(collector, collectorEntity, astSymbol, symbolMetadata) {
...
function _checkForInconsistentReleaseTags(collector, astSymbol, symbolMetadata) {
...
function _checkReferences(collector, astDeclaration, alreadyWarnedEntities) {
    const apiItemMetadata = collector.fetchApiItemMetadata(astDeclaration);
    ...
    for (const referencedEntity of astDeclaration.referencedAstEntities) {
        ...
        if (collectorEntity && collectorEntity.consumable) {
            ...
            if (!alreadyWarnedEntities.has(referencedEntity)) {
                ...
                if (referencedEntity instanceof AstSymbol_1.AstSymbol && _isEcmaScriptSymbol(referencedEntity)) {
...
function _isEcmaScriptSymbol(astSymbol) {
