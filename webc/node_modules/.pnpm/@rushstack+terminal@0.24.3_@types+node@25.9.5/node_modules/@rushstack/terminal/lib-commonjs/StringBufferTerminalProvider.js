...
class StringBufferTerminalProvider {
    _standardBuffer = new node_core_library_1.StringBuilder();
    _verboseBuffer = new node_core_library_1.StringBuilder();
    _debugBuffer = new node_core_library_1.StringBuilder();
    _warningBuffer = new node_core_library_1.StringBuilder();
    _errorBuffer = new node_core_library_1.StringBuilder();
    _allOutputChunks = [];
    /**
