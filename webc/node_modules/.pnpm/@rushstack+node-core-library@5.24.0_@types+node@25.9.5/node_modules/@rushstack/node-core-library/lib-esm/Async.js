...
async function _forEachWeightedAsync(iterable, callback, options) {
    await new Promise((resolve, reject) => {
        ...
        async function queueOperationsAsync() {
            while (concurrentUnitsInProgress < concurrency &&
                ...
                const currentIteratorResult = nextIterator ?? (await iterator.next());
                ...
                if (!iteratorIsComplete) {
                    ...
                    const allowOversubscription = options?.allowOversubscription ?? false;
