...
const _environmentVariableBasePathFnMap = new Map([
...
export class FileError extends Error {
    /** @internal */
    static _sanitizedEnvironmentVariable;
    /** @internal */
    static _environmentVariableIsAbsolutePath = false;
    ...
    static getProblemMatcher(options) {
        const format = options?.format || 'Unix';
        switch (format) {
            case 'Unix':
    ...
    _evaluateBaseFolder() {
        ...
        const baseFolderFn = _environmentVariableBasePathFnMap.get(FileError._sanitizedEnvironmentVariable);
        if (baseFolderFn) {
