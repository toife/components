...
const _invalidNameCharactersRegExp = /[^A-Za-z0-9\-_\.]/;
/**
...
export class PackageNameParser {
    ...
    tryParse(packageName) {
        ...
        const match = nameWithoutScopeSymbols.match(_invalidNameCharactersRegExp);
        if (match) {
...
const _parser = new PackageNameParser();
/**
