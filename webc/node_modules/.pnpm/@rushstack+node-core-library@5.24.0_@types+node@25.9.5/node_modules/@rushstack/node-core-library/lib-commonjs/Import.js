...
let _builtInModules;
function _getBuiltInModules() {
    if (!_builtInModules) {
        _builtInModules = new Set(nodeModule.builtinModules);
    }
...
class Import {
    ...
    static resolveModule(options) {
        ...
        if (allowSelfReference === true) {
            const ownPackage = _getPackageName(normalizedRootPath);
            if (ownPackage &&
...
function _getPackageName(rootPath) {
