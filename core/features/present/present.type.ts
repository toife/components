...
// Present emit
export type PresentEvent = { (e: "close", type?: string): void };
...
export type PresentBackdropAttrOptions = { zIndex: number; backdropTransitionDuration: string; backdropOpacity?: number };
export type PresentAttrOptions = { zIndex: number; presentTransitionDuration: string; presentTranslate: string; presentOpacity: number; className?: unknown; placement: string; style?: unknown };
